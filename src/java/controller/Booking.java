...
public class Booking extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<FieldTimeOrder> listAllFieldTimeOnDay = FieldTimeOrderDAO.INSTANCE.getFieldAllTimeByDay(checkDate);

        List<FieldTime> fieldTimelist = FieldTimeDAO.INSTANCE.getAllFieldTime();
        request.setAttribute("checkDate", checkDate);
        request.setAttribute("listAllFieldTimeOnDay", listAllFieldTimeOnDay);
