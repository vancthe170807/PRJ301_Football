    ...
    <body>
        ...
        <div class="container mt-5">
            <c:if test="${sessionScope.currentUser.role == 1}">
                <button class="btn btn-secondary" type="button" data-toggle="modal" data-target="#addEquipmentModal">Thêm Phụ Kiện</button>
            </c:if>
            <!-- Add Equipment Modal -->
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addEquipmentModalLabel">Thêm Phụ Kiện Mới</h5>
                        </div>
                        <div class="modal-body">
                            <form id="addEquipmentForm" action="manageequipment" method="post">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <c:forEach var="e" items="${equipmentList}">
                                <tr class="food-row" data-food-id="${e.equipment_id}"> 
                                    <td><img src="img/${e.img}" alt="${e.equipment_name}" style="max-width: 100px;"></td>
                                    <td class="food-name">${e.equipment_name}</td>
                                    <td class="price">${e.price}</td>
                                    <c:if test="${sessionScope.currentUser.role == 1}">
                                        <td>
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#popup-details-${e.equipment_id}">Update</button>
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal${e.equipment_id}">Delete</button>
                                        </td>
                                    </c:if>
                                </tr>
                                <!-- Update Modal -->
                            <div class="modal fade" id="popup-details-${e.equipment_id}" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
                                        ...
                                        <div class="modal-body">
                                            <form action="manageequipment" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="equipment_name" name="equipment_name" value="${e.equipment_name}" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="price">Price</label>
                                                    <input type="number" class="form-control" id="price" name="price" value="${e.price}" required>
                                                </div>
                                                <div class="form-group"  style="margin-top: 10px">
                                                    <div class="op-up-up-coming-event">
                                                        <input type="file" id="image" name="img" accept="image/gif, image/jpg, image/png" onchange="chooseFile(this)" />
                            ...
                            <div class="modal fade" id="deleteModal${e.equipment_id}" tabindex="-1" aria-labelledby="deleteModalLabel${e.equipment_id}" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="deleteModalLabel${e.equipment_id}">Confirm Delete</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            Are you sure you want to delete ${e.equipment_name}?
                                        </div>
        ...
        <form id="dataForm" action="food" method="post">
